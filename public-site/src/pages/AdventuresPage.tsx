      ...
      <section className="py-16 bg-white">
        <div className="max-w-3xl mx-auto px-4 text-center">
          ...
          <p className="text-gray-600 text-lg mb-8">
            ...
            mentor the next generation of makers—we're always adding new
            programs and would love to hear your ideas.
          </p>

          <div className="bg-gray-50 rounded-2xl p-6 max-w-xl mx-auto mb-8">
            <p className="text-gray-700 text-lg font-medium mb-4">
              Stop by our makerspace in person or give us a call—we'd love to meet you!
            </p>
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              <a
                href="tel:+15807168484"
